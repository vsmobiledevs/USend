...
sealed class Resource<T>(
    ...
    val id: Int? = null,
    val model: Any? = null,
    val messageError: SquareupErrorResponse? = null,
) {
    class Success<T>(data: T) : Resource<T>(data = data)

    class SuccessCancel<T>(data: T) : Resource<T>(data = data)
    ...
    class GetCarrierListSucess<T>(data: T) : Resource<T>(data = data)
    ...
    class SquareupError<T>(data: T) : Resource<T>(data = data)
    class Loading<T>(isLoadingShow: Boolean) : Resource<T>(isLoadingShow = isLoadingShow)
    class Error<T>(message: String) : Resource<T>(message = message)
    class SquareupFailureError<T>(message: String) : Resource<T>(message = message)
    class SquareupUrlError<T>(message: String) : Resource<T>(message = message)
