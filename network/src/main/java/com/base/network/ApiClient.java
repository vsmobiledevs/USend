...
import com.base.network.auth.ApiKeyAuth;
import com.base.network.auth.HttpBasicAuth;
import com.base.network.auth.OAuth;
import com.base.network.auth.OAuth.AccessTokenListener;
...
public class ApiClient {
    ...
    private Retrofit.Builder adapterBuilderSquareup;
    private JSON json;
    ...
    public void createDefaultAdapter() {
        json = new JSON();
        okBuilder = new OkHttpClient.Builder().connectTimeout(3, TimeUnit.MINUTES)
        ...
        adapterBuilderSquareup = new Retrofit
                .Builder()
                .baseUrl(baseUrlSquareup)
                .addConverterFactory(GsonConverterFactory.create());
    }
    ...
    public <S> S createServiceSquareup(Class<S> serviceClass) {
        return adapterBuilderSquareup
                .client(okBuilder.build())
                .build()
                .create(serviceClass);
    }
